                    ...
                    <form action="{{ route('admin.room.book') }}" class="booking-form" id="booking-form" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label>
                                        @lang('Custom total amount')
                                        <span class="text-success">(@lang('Optional'))</span>
                                    </label>
                                    <input class="form-control" min="0" name="custom_total" placeholder="@lang('Custom total amount')" step="any" type="number">
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" min="0" name="paid_amount" placeholder="@lang('Paid Amount')" step="any" type="number">
                                </div>
                            </div>
                            @can('admin.room.book')
